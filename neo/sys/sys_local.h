...
public:
	...
	virtual dllHandle_t     DLL_Load(const char* dllName);	//x64FIXES
	virtual void*			DLL_GetProcAddress(dllHandle_t dllHandle, const char* procName);
	virtual void            DLL_Unload(dllHandle_t dllHandle);
